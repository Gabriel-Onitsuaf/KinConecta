(function () {
  ...
  const landingTourImage = (...candidates) => {
    ...
    const tourAssetUrl = (fileName) =>
      new URL(`./frontend/src/assets/tours/categories/${fileName}`, window.location.href).href;
  ...
  const guideAssetUrl = () =>
    new URL("./frontend/src/assets/users/user_guide.png", window.location.href).href;
