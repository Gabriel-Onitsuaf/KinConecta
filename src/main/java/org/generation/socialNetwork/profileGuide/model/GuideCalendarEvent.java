...
public class GuideCalendarEvent {
    ...
    @Convert(converter = GuideCalendarEventEventTypeConverter.class)
    ...
    @Convert(converter = GuideCalendarEventSourceConverter.class)
    @Column(name = "source")
    private GuideCalendarEventSource source;

    @Convert(converter = GuideCalendarEventStatusConverter.class)
    @Column(name = "status")
